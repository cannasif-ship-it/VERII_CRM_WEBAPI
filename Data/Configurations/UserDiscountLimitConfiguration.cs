...
{
    public class UserDiscountLimitConfiguration : IEntityTypeConfiguration<UserDiscountLimit>
    {
        public void Configure(EntityTypeBuilder<UserDiscountLimit> builder)
        {
            // Table name
