...
namespace cms_webapi.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        public AuthController(CmsDbContext context, IConfiguration config, IHubContext<AuthHub> hubContext, ILocalizationService localizationService, IAuthService authService)
        {
            _context = context;
            _config = config;
