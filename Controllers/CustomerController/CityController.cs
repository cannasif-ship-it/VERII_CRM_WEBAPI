...
namespace cms_webapi.Controllers
{
    ...
    public class CityController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<ApiResponse<List<CityGetDto>>>> GetAllCities()
        {
        ...
        public async Task<ActionResult<ApiResponse<CityGetDto>>> CreateCity([FromBody] CityCreateDto cityCreateDto)
        {
            ...
            {
                return BadRequest(ApiResponse<CityGetDto>.ErrorResult(_localizationService.GetLocalizedString("ValidationError"), "ValidationFailed", 400));
            }
