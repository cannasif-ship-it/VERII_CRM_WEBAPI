...
namespace cms_webapi.Controllers
{
    ...
    public class ProductPricingGroupByController : ControllerBase
    {
        ...
        [HttpGet]
        public async Task<ActionResult<ApiResponse<IEnumerable<ProductPricingGroupByDto>>>> GetAllProductPricingGroupBys()
        {
            var result = await _productPricingGroupByService.GetAllProductPricingGroupBysAsync();
